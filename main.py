...
def main():
	...
	num_classes  = 10
	num_epoch = 3
	max_number_filter_change = 8
	max_size_filter_change = 4
	max_number_filter = 20
	max_filter_size = 8
	...
	cnn.configure_data()
	#(self, initialPoblation, control, num_survivors, condition_precision, condition_generations, cnn)
	simulator = Simulator(individuals, control, survivors, None, 4, cnn, 3)
	simulator.simulate()
